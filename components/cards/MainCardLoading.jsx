...
const MainCardLoading = () => {
  ...
  return (
    <div className={"bg-white shadow-sm rounded overflow-hidden flex flex-col sm:flex-row md:max-h-94 lg:flex-col mb-4 lg:h-full"}>
      ...
      <div className={"flex flex-col p-4 sm:basis-1/2 md:basis-full lg:basis-auto bg-red-700"}>
        <div className={"text-slate-400 text-sm"}>{"Date"}</div>
        <h1 className={" pb-4 text-lg md:text-2xl text-slate-900 font-bold antialiased tracking-tight"}>Loading...</h1>
        <div>
